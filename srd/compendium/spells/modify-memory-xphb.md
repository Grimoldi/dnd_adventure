...
A [Remove Curse](srd/compendium/spells/remove-curse-xphb.md) or [Greater Restoration](srd/compendium/spells/greater-restoration-xphb.md) spell cast on the target restores the creature's true memory.
