...
**Classes**: [Bard](srd/compendium/lists/list-spells-classes-bard.md); [Cleric](srd/compendium/lists/list-spells-classes-cleric.md); [Sorcerer](srd/compendium/lists/list-spells-classes-sorcerer.md); [Warlock](srd/compendium/lists/list-spells-classes-warlock.md); [Wizard](srd/compendium/lists/list-spells-classes-wizard.md)
