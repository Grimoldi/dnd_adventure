...
An immobile, [Invisible](srd/rules/conditions.md#Invisible), [Cube](srd/rules/variant-rules/cube-area-of-effect-xphb.md)-shaped prison composed of magical force springs into existence around an area you choose within range. The prison can be a cage or a solid box, as you choose.
...
This spell can't be dispelled by [Dispel Magic](srd/compendium/spells/dispel-magic-xphb.md).

**Classes**: [Bard](srd/compendium/lists/list-spells-classes-bard.md); [Warlock](srd/compendium/lists/list-spells-classes-warlock.md); [Wizard (Evoker)](srd/compendium/lists/list-spells-classes-evoker-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](srd/compendium/lists/list-spells-classes-wizard.md)
