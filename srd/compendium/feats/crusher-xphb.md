...
**Enhanced Critical.** When you score a [Critical Hit](srd/rules/variant-rules/critical-hit-xphb.md) that deals Bludgeoning damage to a creature, attack rolls against that creature have [Advantage](srd/rules/variant-rules/advantage-xphb.md) until the start of your next turn.