...
```ad-statblock
title: Owl
![](bestiary/tokens/XMM/Owl.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](srd/rules/skills.md#Perception) +5, [Stealth](srd/rules/skills.md#Stealth) +5
- **Senses** [Darkvision](srd/rules/senses.md#Darkvision) 120 ft., passive Perception 15
- **Languages** —
- **Challenge** 0

## Traits

***Flyby.*** The owl doesn't provoke [Opportunity Attacks](srd/rules/actions.md#Opportunity%20Attack) when it flies out of an enemy's reach.
