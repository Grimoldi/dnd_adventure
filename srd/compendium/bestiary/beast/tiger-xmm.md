...
```ad-statblock
title: Tiger
![](bestiary/tokens/XMM/Tiger.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](srd/rules/skills.md#Perception) +3, [Stealth](srd/rules/skills.md#Stealth) +7
- **Senses** [Darkvision](srd/rules/senses.md#Darkvision) 60 ft., passive Perception 13
- **Languages** —
- **Challenge** 1

## Actions

***Rend.*** *Melee Attack Roll:* `+5`, reach 5 ft. *Hit:* 10 (`2d6 + 3`) Slashing damage. If the target is a Large or smaller creature, it has the [Prone](srd/rules/conditions.md#Prone) condition.
