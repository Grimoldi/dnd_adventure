...
```ad-statblock
title: Reef Shark
![](bestiary/tokens/XMM/Reef Shark.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](srd/rules/skills.md#Perception) +2
- **Senses** [Blindsight](srd/rules/senses.md#Blindsight) 30 ft., passive Perception 12
- **Languages** —
- **Challenge** 1/2

## Traits

***Pack Tactics.*** The shark has [Advantage](srd/rules/variant-rules/advantage-xphb.md) on an attack roll against a creature if at least one of the shark's allies is within 5 feet of the creature and the ally doesn't have the [Incapacitated](srd/rules/conditions.md#Incapacitated) condition.
