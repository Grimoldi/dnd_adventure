...
```ad-statblock
title: Crab
![](bestiary/tokens/XMM/Crab.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Stealth](srd/rules/skills.md#Stealth) +2
- **Senses** [Blindsight](srd/rules/senses.md#Blindsight) 30 ft., passive Perception 9
- **Languages** —
- **Challenge** 0
