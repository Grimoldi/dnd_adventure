...
```ad-statblock
title: Giant Spider
![](bestiary/tokens/XMM/Giant Spider.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](srd/rules/skills.md#Perception) +4, [Stealth](srd/rules/skills.md#Stealth) +7
- **Senses** [Darkvision](srd/rules/senses.md#Darkvision) 60 ft., passive Perception 14
- **Languages** —
- **Challenge** 1
...
***Web (Recharge 5-6).*** *Dexterity Saving Throw:* DC 13, one creature the spider can see within 60 feet. *Failure:* The target has the [Restrained](srd/rules/conditions.md#Restrained) condition until the web is destroyed (AC 10; HP 5; [Vulnerability](srd/rules/variant-rules/vulnerability-xphb.md) to Fire damage; [Immunity](srd/rules/variant-rules/immunity-xphb.md) to Poison and Psychic damage).
```
^statblock
