...
```ad-statblock
title: Zombie
![](bestiary/tokens/XMM/Zombie.webp#token)
...
- **Skills** ⏤
- **Senses** [Darkvision](srd/rules/senses.md#Darkvision) 60 ft., passive Perception 8
- **Damage Immunities** poison
- **Condition Immunities** [exhaustion](srd/rules/conditions.md#Exhaustion), [poisoned](srd/rules/conditions.md#Poisoned)
- **Languages** understands Common plus one other language but can't speak
- **Challenge** 1/4

## Traits

***Undead Fortitude.*** If damage reduces the zombie to 0 [Hit Points](srd/rules/variant-rules/hit-points-xphb.md), it makes a Constitution saving throw (DC 5 plus the damage taken) unless the damage is Radiant or from a [Critical Hit](srd/rules/variant-rules/critical-hit-xphb.md). On a successful save, the zombie drops to 1 [Hit Point](srd/rules/variant-rules/hit-points-xphb.md) instead.
