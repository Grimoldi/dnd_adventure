...
You can fire only one piece of ammunition from a Loading weapon when you use an action, a [Bonus Action](srd/rules/variant-rules/bonus-action-xphb.md), or a [Reaction](srd/rules/variant-rules/reaction-xphb.md) to fire it, regardless of the number of attacks you can normally make.
