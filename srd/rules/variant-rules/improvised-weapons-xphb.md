...
Don't add your [Proficiency Bonus](srd/rules/variant-rules/proficiency-xphb.md) to attack rolls with an improvised weapon.
...
If an improvised weapon resembles a Simple or Martial weapon, the DM may say it functions as that weapon and uses that weapon's rules. For example, the DM could treat a table leg as a [Club](srd/compendium/items/club-xphb.md).